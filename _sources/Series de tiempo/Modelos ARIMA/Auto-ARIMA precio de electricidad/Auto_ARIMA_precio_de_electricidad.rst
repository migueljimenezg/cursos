...
De acuerdo con la PACF, inicialmente se podrían considerar combinaciones
hasta un modelo AR(4), y según la ACF, hasta un MA(3). No obstante,
estos valores constituyen únicamente una guía inicial.

Mediante el uso del auto-ARIMA, es posible evaluar modelos con mayores
rezagos. Dado que se observan rezagos significativos hasta el lag 13, se
probarán todas las combinaciones posibles de ARIMA(p,1,q) con p y q
entre 0 y 13, es decir, hasta un ARIMA(13,1,13).
