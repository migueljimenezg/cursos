...
.. important::
    ...
    * **Descargue** :download:`Random Walk y primera diferencia.xlsx <Random Walk y primera diferencia.xlsx>`
    
    * **Descargue** :download:`Prueba ADF Temperatura Medellín.xlsx <Prueba ADF Temperatura Medellín.xlsx>`

    * **Descargue** :download:`ACF y PACF-temperatura Medellín.xlsx <ACF y PACF-temperatura Medellín.xlsx>`
